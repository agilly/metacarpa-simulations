...
heritability=$1
file=$2
name=$file.$1.normalised_uniform_standard
/software/bin/Rscript --vanilla /lustre/scratch114/projects/helic/checkpoints/metacarpa_sim/polygeny/makepheno_maf_normalised_uniform_standard.R $file $heritability
sleep 5
...
/software/bin/Rscript --vanilla /lustre/scratch114/projects/helic/checkpoints/metacarpa_sim/polygeny/getgraph.R $name
