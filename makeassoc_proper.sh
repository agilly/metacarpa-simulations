#!/bin/bash
heritability=$1
name=proper_betaallequal.$1
/software/bin/Rscript --vanilla /lustre/scratch114/projects/helic/checkpoints/metacarpa_sim/polygeny/makepheno_proper.R $heritability
sleep 5
